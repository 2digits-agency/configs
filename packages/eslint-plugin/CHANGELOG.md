...
- 433d415: Update TypeScript ESLint utilities

  - Updated `@typescript-eslint/scope-manager` to 8.61.0
  - Updated `@typescript-eslint/utils` to 8.61.0

## 4.0.17

### Patch Changes

- 128f6a2: Update eslint to 10.4.1
...
- 5715cd2: Update TypeScript ESLint utilities

  - Updated `@typescript-eslint/scope-manager` to 8.59.2
  - Updated `@typescript-eslint/utils` to 8.59.2
...
- e1f712a: Update ESLint dependencies
  ...
  - Updated `@typescript-eslint/scope-manager` to 8.59.1
...
- bd8396a: Enhance ESLint plugin rules with autofixes and dependency cleanup
...
- e72363d: Updated eslint-vitest-rule-tester
