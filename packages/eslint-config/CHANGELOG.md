...
- Updated `@eslint/css` to 2.0.0, `tailwind-csstree` to 0.4.0, and `@effect/tsgo` to 0.39.1
- Refreshed the generated ESLint rule option types for the updated Effect TypeScript tooling

### Update pkg-types to 2.3.2



### Update eslint-plugin-storybook to 10.6.0
...
- bfb16bd: Update ESLint core and plugins

  - Updated `eslint` to 10.7.0 and TypeScript ESLint packages to 8.64.0
  - Updated React, Vitest, de Morgan, Node, SonarJS, Turbo, Unicorn, and Zod ESLint dependencies
  - Enabled new Zod rules for conflicting checks, unnecessary readonly schemas, and tuple-shaped arrays
  - Refreshed generated rule types and config snapshots for upstream rule and metadata changes

- Updated dependencies [bfb16bd]
...
- Updated dependencies [7916d9c]
  - @2digits/eslint-plugin@4.0.21
...
- 0b1927b: Update ESLint plugins and enable duplicate Zod method checks

  - Updated `@eslint-react/eslint-plugin` and `@eslint-react/kit` to 5.8.10
  - Updated `@next/eslint-plugin-next` to 16.2.7, `@tanstack/eslint-plugin-query` to 5.101.0, `@vitest/eslint-plugin` to 1.6.19, `eslint-plugin-jsdoc` to 63.0.1, and `eslint-plugin-storybook` to 10.4.2
  - Updated `eslint-plugin-zod` to 4.6.0 and enabled `zod/no-duplicate-schema-methods`
  - Updated generated types and full-config snapshot for new rule metadata

## 5.5.4

### Patch Changes

- 128f6a2: Update ESLint core and plugins

  - Updated `eslint` to 10.4.1
  - Updated `@eslint-react/eslint-plugin` and `@eslint-react/kit` to 5.8.8
  - Updated `@eslint/config-inspector` to 3.0.4
  - Updated `@eslint/css` to 1.3.0
  - Updated `eslint-plugin-jsonc` to 3.2.0
  - Updated `eslint-plugin-toml` to 1.4.0
  - Updated `eslint-plugin-turbo` to 2.9.16
  - Updated `eslint-plugin-yml` to 3.4.0
  - Updated `eslint-plugin-zod` to 4.5.4
  - Updated generated types for rule metadata and CSS baseline changes

- Updated dependencies [128f6a2]
  - @2digits/eslint-plugin@4.0.17

## 5.5.3

### Patch Changes

- 626d181: Update ESLint plugins
...
- cb2b172: Update ESLint plugins and dependencies
...
- ec8ea99: Update @eslint-react/eslint-plugin to 5.7.8 and add @eslint-react/kit for custom rules
...
- e665a3c: Update ESLint plugin dependencies

  - Updated `eslint-plugin-turbo` to 2.9.14
  - Updated `@eslint-react/kit` to 5.7.8

- 62087fd: Update eslint-plugin-storybook to 10.4.0

## 5.4.15

### Patch Changes

- 1389c83: Update ESLint plugins and enable additional zod rules

  - Updated `eslint-plugin-zod` to 4.4.0
  - Added `zod/no-native-enum`, `zod/no-schema-with-is-optional`, `zod/no-schema-with-is-nullable`, `zod/prefer-loose-object`, and `zod/prefer-strict-object` rules
  - Updated `eslint-plugin-antfu` to 3.2.3
  - Updated `@tanstack/eslint-plugin-query` to 5.100.10
  - Updated `@eslint/config-inspector` to 3.0.2
  - Updated `typescript-eslint` and `@typescript-eslint/*` packages to 8.59.3
  - Updated generated types with new rule definitions and documentation improvements

- Updated dependencies [1389c83]
...
- 5715cd2: Update ESLint dependencies

  - Updated `@typescript-eslint/parser`, `@typescript-eslint/utils`, and `typescript-eslint` to 8.59.2
  - Updated `eslint-plugin-n` to 18.0.0
  - Updated `eslint-plugin-turbo` to 2.9.9
  - Updated generated types for new Node globals and rule options

- Updated dependencies [5715cd2]
  - @2digits/eslint-plugin@4.0.14
...
- 8837219: Update ESLint plugins

  - Updated `typescript-eslint` to 8.59.0
  - Updated `@typescript-eslint/parser` to 8.59.0
  - Updated `@typescript-eslint/utils` to 8.59.0
  - Removed unnecessary type assertions in Next.js, CSS, and Vite config generation

## 5.4.4

### Patch Changes

- 211e03f: Update ESLint plugins

  - Updated `eslint-plugin-zod` to 3.7.0
    - Added `zod/no-transform-in-record-key` rule to prevent silent key mutations in `z.record()` schemas
    - Reorganized rule configuration order
  - Updated `eslint-plugin-sonarjs` to 4.0.3 with new rule types and documentation improvements
  - Updated `@next/eslint-plugin-next` to 16.2.4
  - Updated `@tanstack/eslint-plugin-query` to 5.99.2
  - Updated `@eslint/config-inspector` to 2.0.0
  - Updated `eslint` to 10.2.1

- Updated dependencies [211e03f]
...
- 9e37180: Update ESLint plugins

  - Updated `@typescript-eslint/parser` to 8.58.2
  - Updated `@typescript-eslint/scope-manager` to 8.58.2
  - Updated `@typescript-eslint/utils` to 8.58.2
  - Updated `@vitest/eslint-plugin` to 1.6.16
  - Updated `eslint-plugin-zod` to 3.5.4
  - Updated `typescript-eslint` to 8.58.2
...
- e64972b: Add Vitest ESLint plugin configuration
...
- 692a9b0: Update ESLint ecosystem dependencies

  - Added `.opencode/package-lock.json` to the generated gitignore-based ignore patterns in `@2digits/eslint-config`
  - Updated `@2digits/eslint-config` to use `@eslint/compat` 2.0.5, `@next/eslint-plugin-next` 16.2.3, `typescript-eslint` 8.58.1, `eslint-plugin-storybook` 10.3.5, and `eslint-plugin-turbo` 2.9.5
  - Updated `@2digits/eslint-plugin` to use `@typescript-eslint/scope-manager` and `@typescript-eslint/utils` 8.58.1

- Updated dependencies [692a9b0]
...
- 571f544: Update ESLint and plugin dependencies
  - Updated `eslint` from 10.0.3 to 10.1.0
  - Updated `@next/eslint-plugin-next` from 16.2.0 to 16.2.1
  - Updated `@tanstack/eslint-plugin-query` from 5.91.5 to 5.95.0, including new `allowlist` option for `tanstack-query/exhaustive-deps` rule
  - Updated `tailwind-csstree` from 0.1.5 to 0.2.0
...
- cddb192: Update ESLint plugins
  ...
  - Updated `eslint-plugin-turbo` to 2.8.19
  - Removed index signature `[k: string]: unknown` from `StorybookNoUninstalledAddons` type (upstream change in `eslint-plugin-storybook`)

- Updated dependencies [cddb192]
...
- 180fa00: Migrate to @eslint-react/eslint-plugin v3
...
- 175947e: Update ESLint plugins
  - Updated `eslint-plugin-jsdoc` to 62.8.0
  - Updated `eslint-plugin-jsonc` to 3.1.2
  - Updated `eslint-plugin-sonarjs` to 4.0.2 with minor rule doc improvements
  - Updated `eslint-plugin-turbo` to 2.8.16
  - Updated `eslint-plugin-zod` to 3.5.0
  - Regenerated `types.gen.d.ts`
...
- 2ea465f: Update ESLint plugins and typescript-eslint
  ...
  - Updated `eslint-plugin-storybook` to 10.2.17
  - Updated `eslint-plugin-turbo` to 2.8.15
  - Updated `eslint-flat-config-utils` to 3.0.2
  - Regenerated `types.gen.d.ts`

- Updated dependencies [2ea465f]
...
- 7355a63: Update ESLint core and plugins
  - Updated `eslint` to 10.0.3
  - Updated `@eslint/compat` to 2.0.3
  - Updated `@stylistic/eslint-plugin` to 5.10.0 with `"off"` support in list-style overrides and `lineMode` option for padding-line-between-statements
  - Updated `eslint-plugin-sonarjs` to 4.0.1, adding new `sonar/code-eval` rule
  - Updated `eslint-plugin-storybook` to 10.2.16
  - Updated `eslint-plugin-turbo` to 2.8.14
  - Updated `graphql-config` to 5.1.6
  - Regenerated `types.gen.d.ts`
...
- f446e43: Update eslint-plugin-storybook and restructure dependencies
...
- b8fce21: Update ESLint plugins (depend, toml, turbo, yml, zod, config-inspector)
  - Updated `eslint-plugin-depend` to 1.5.0
  - Updated `eslint-plugin-toml` to 1.3.1
  - Updated `eslint-plugin-turbo` to 2.8.13
  - Updated `eslint-plugin-yml` to 3.3.1
  - Updated `eslint-plugin-zod` to 3.4.0
  - Updated `@eslint/config-inspector` to 1.5.0 with ESLint 10 peer support
  - Regenerated `types.gen.d.ts` with minor whitespace updates
...
- 5149bf0: Update ESLint plugins (zod, eslint-comments, github-action, de-morgan, turbo, globals)
  - Updated `eslint-plugin-zod` to 3.3.0 and enabled new `zod/prefer-string-schema-with-trim` rule
  - Updated `@eslint-community/eslint-plugin-eslint-comments` to 4.7.0
  - Updated `eslint-plugin-github-action` to 0.2.0 with improved rule descriptions
  - Updated `eslint-plugin-de-morgan` to 2.1.1
  - Updated `eslint-plugin-turbo` to 2.8.12
...
- d22e0ed: Update ESLint plugins (eslint, typescript-eslint, toml, jsonc, yml, jsdoc, pnpm, storybook)
  - Updated `eslint` to 10.0.2
  - Updated `typescript-eslint` suite to 8.56.1
  - Updated `eslint-plugin-toml` to 1.3.0, adding `toml/inline-table-curly-newline` and `toml/inline-table-key-value-newline` rules
  - Updated `eslint-plugin-jsonc` to 3.1.0 with `emptyObjects` option for curly-spacing rules
  - Updated `eslint-plugin-yml` to 3.3.0 with `emptyObjects` option for flow-mapping-curly-spacing
  - Updated `eslint-plugin-jsdoc` to 62.7.1
  - Updated `eslint-plugin-pnpm` to 1.6.0 with ESLint 10 peer support
  - Updated `eslint-plugin-storybook` to 10.2.12

## 5.1.12

### Patch Changes

- d643f5d: Update ESLint plugins and parsers
  - Updated `eslint` to 10.0.1
  - Updated `eslint-config-flat-gitignore` to 2.2.1
  - Updated `eslint-plugin-jsdoc` to 62.7.0
  - Updated `eslint-plugin-jsonc` to 3.0.0 — removes explicit `languageOptions.parser` from JSONC configs (now handled internally), adds `jsonc/no-irregular-whitespace` rule
  - Updated `eslint-typegen` to 2.3.1
  - Updated `jsonc-eslint-parser` to 3.1.0
  - Updated `@stylistic/eslint-plugin` to 5.9.0 — adds selector-based matching for `padding-line-between-statements`
  - Updated `@tanstack/eslint-plugin-router` to 1.161.4

## 5.1.11

### Patch Changes

- c81341c: Update ESLint plugin dependencies with breaking changes
...
- a33b04c: Update ESLint and plugin dependencies
  - Updated `eslint` to `10.0.0` and `@eslint/js` to `10.0.1`
  - Updated `@typescript-eslint/*`, `eslint-plugin-jsdoc`, `eslint-plugin-storybook`, `eslint-plugin-toml`, and `eslint-plugin-yml`
  - Added new ESLint core recommended rules: `no-unassigned-vars`, `no-useless-assignment`, and `preserve-caught-error`
...
- 590eea0: Update ESLint plugins to latest versions
  ...
  - Updated `@eslint-react/eslint-plugin` to 2.13.0
  - Updated `eslint-plugin-n` to 17.24.0
  - Updated `eslint-plugin-antfu` to 3.2.2
  - Updated `eslint-plugin-jsdoc` to 62.5.5
  - Updated `eslint-plugin-turbo` to 2.8.9

- 834baf1: Update ESLint plugin dependencies
  - Updated `eslint-plugin-antfu` to 3.2.1
  - Updated `eslint-plugin-sonarjs` to 3.0.7
    - Updated rule descriptions for `sonar/no-hardcoded-passwords` and `sonar/no-hardcoded-secrets`
  - Updated `eslint-plugin-turbo` to 2.8.7

## 5.1.8

### Patch Changes

- 13454b5: Update ESLint plugin dependencies
  - Updated `@eslint-react/eslint-plugin` to 2.12.4
  - Updated `@stylistic/eslint-plugin` to 5.8.0
    - Added experimental `exp-jsx-props-style` rule
  - Updated `typescript-eslint` to 8.55.0
    - `ts/no-useless-default-assignment` now accepts options
  - Updated `eslint-plugin-jsonc` to 2.21.1
  - Updated `eslint-plugin-storybook` to 10.2.8
  - Updated `eslint-plugin-turbo` to 2.8.4
  - Updated `eslint-plugin-unicorn` to 63.0.0
    - Added `unicorn/isolated-functions` rule
...
- 1fcaa08: Update ESLint plugin dependencies
  - Updated `@eslint-react/eslint-plugin` to 2.12.1
  - Updated `eslint-flat-config-utils` to 3.0.1
  - Updated `eslint-plugin-antfu` to 3.2.0
  - Updated `eslint-plugin-jsdoc` to 62.5.4
  - Updated `eslint-plugin-toml` to 1.0.4
  - Updated `eslint-plugin-yml` to 3.1.2
  - Updated `eslint-vitest-rule-tester` to 3.1.0
  - Added patch for `@eslint/plugin-kit` to fix CJS type exports

## 5.1.5

### Patch Changes

- 0877a3c: Update ESLint plugin dependencies
  - Updated `@eslint-react/eslint-plugin` to 2.11.0
    - Added `react-rsc` plugin with `react-rsc/function-definition` rule
    - Updated description for `react-extra/no-implicit-key` rule
    - Disabled `react-extra/no-implicit-key` in markdown code blocks
  - Updated `eslint-plugin-jsdoc` to 62.5.2
  - Updated `eslint-plugin-storybook` to 10.2.7
  - Updated `eslint-plugin-turbo` to 2.8.3

## 5.1.4

### Patch Changes

- 887ec1f: Update ESLint plugin dependencies
  - Updated `@eslint-react/eslint-plugin` to 2.9.3
  - Updated `eslint-plugin-storybook` to 10.2.4
  - Updated `eslint-plugin-turbo` to 2.8.2
  - Updated `globals` to 17.3.0
...
- 6aec756: Update ESLint plugin dependencies
  - Updated `@eslint-react/eslint-plugin` to 2.7.4 with improved rule descriptions
  - Updated `@stylistic/eslint-plugin` to 5.7.1
  - Updated `@tanstack/eslint-plugin-router` to 1.155.0 with new `route-param-names` rule
  - Updated `eslint-plugin-jsdoc` to 62.4.1 with new `trailingPunctuationMultilineOnly` option
  - Updated `eslint-plugin-regexp` to 3.0.0
  - Updated `eslint-plugin-turbo` to 2.7.6
  - Updated `globals` to 17.1.0
...
- 8e17255: Update ESLint plugin dependencies and fix yaml-eslint-parser v2.0.0 breaking change
...
- 391e92e: Update @eslint-react/eslint-plugin to 2.6.0
  - Added `react-extra/no-unnecessary-use-ref` rule to detect unnecessary `useRef` usage
  - Updated `@eslint-community/eslint-plugin-eslint-comments` to 4.6.0
  - Updated `eslint-plugin-n` to 17.23.2

## 5.0.3

### Patch Changes

- 207ef36: Update ESLint plugin dependencies
  - Updated `typescript-eslint` packages to 8.53.0
    - Added new `ts/strict-void-return` rule
    - Added `enableAutofixRemoval` option to `ts/no-unused-vars`
  - Updated `@eslint-react/eslint-plugin` to 2.5.7
    - Updated `react-extra/no-unnecessary-key` rule description
  - Updated `eslint-plugin-turbo` to 2.7.4
  - Updated `eslint-plugin-zod-x` to 2.0.1
...
- Updated dependencies [5d736fe]
- Updated dependencies [92a4d08]
  - @2digits/eslint-plugin@3.6.0
...
- 83fc578: Add factory tests and expand fixture tests for multiple presets
...
- 5bb81a2: Updated dependencies
- 806698a: Updated dependencies
- Updated dependencies [806698a]
  - @2digits/eslint-plugin@3.2.14
...
- Updated dependencies [be22273]
  - @2digits/eslint-plugin@3.2.11
...
- Updated dependencies [7df2a2b]
  - @2digits/eslint-plugin@3.2.10
...
- 1afed76: Updated dependencies
- Updated dependencies [1afed76]
  - @2digits/eslint-plugin@3.2.8
...
- Updated dependencies [7679d2b]
  - @2digits/eslint-plugin@3.2.6
